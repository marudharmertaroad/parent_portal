...
const LoginForm: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-yellow-900 via-indigo-900 to-yellow-900 flex items-center justify-center p-4 relative overflow-hidden">
